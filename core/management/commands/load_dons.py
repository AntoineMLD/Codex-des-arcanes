...
class Command(BaseCommand):
    help = "Charge les données des dons depuis des fichiers JSON."
    ...
    def handle(self, *args, **kwargs):
        ...
        for file_name in os.listdir(folder_path):
            if file_name.startswith("dons_") and file_name.endswith(".json"):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"{files_loaded} fichiers de dons chargés avec succès.")
        )
