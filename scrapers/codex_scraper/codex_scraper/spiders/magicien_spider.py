...
class MagicienSpider(scrapy.Spider):
    name = "magicien_spider"
    allowed_domains = ["aidedd.org"]
    start_urls = ["https://www.aidedd.org/regles/classes/magicien/"]
    ...
    def parse(self, response):
        ...
        for table in response.xpath("//table"):
            ...
            if headers and rows:
                tables.append({"name": "Progression du magicien", "data": rows})
